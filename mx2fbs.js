...
function elcreativeAuthProfile () {
  firebase.auth().onAuthStateChanged(function(rtdb) {
    ...
    if (rtdb) {
      ...
      postContent = "";
      postContent = '<div class="elcreative_tab" role="tablist"><div class="tab_button_container"><button id="tab_button_post" class="tab_button" aria-controls="tab_panel_post" type="button" data-toggle-target="#tab_panel_post" data-toggle-radio-group="tabsGroup_jWIl4" data-toggle-is-active role="tab" aria-selected="false" data-toggle-arrows data-toggle-class> tab 1 </button><button id="tab_button_post1" class="tab_button" aria-controls="tab_panel_post1" type="button" data-toggle-target="#tab_panel_post1" data-toggle-radio-group="tabsGroup_jWIl4" data-toggle-is-active role="tab" aria-selected="false" data-toggle-arrows data-toggle-class> tab 2 </button></div><div id="tab_panel_post" class="tab_panel_post" role="tabpanel" aria-labelledby="tab_button_post" aria-hidden="true">Tab 1</div>  <div id="tab_panel_post1" class="tab_panel_post1" role="tabpanel" aria-labelledby="tab_button_post" aria-hidden="true">Tab 2</div></div>';
